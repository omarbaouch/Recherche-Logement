# 📋 Suivi des candidatures — Logement social Strasbourg
...
- **Surface :** **minimum 40 m²**
- **Occupants :** 1 personne (seul)
- **Secteurs :** Strasbourg (Neudorf, Montagne Verte, Esplanade-Krutenau, Meinau, Orangerie/Quartiers des XV, Centre) + Illkirch-Graffenstaden
- **Refus :** rez-de-chaussée

## 💼 Profil (rappel pour les bailleurs)
- CDI secteur privé — Consultant Delivery (employeur à Schiltigheim 67300)
- Revenu net ≈ 2 385 €/mois · Revenu fiscal de référence 2024 : 31 637 €
- Locataire actuel d'un logement privé (75 rue d'Ostwald, 67200 Strasbourg)
...
|----------|----------|-------|-----------|--------------|
| ~~**Marianne GALLOCHER**~~ | Responsable Pole Clients | ~~`marianne.gallocher@afedim.fr`~~ | ❌ **BOUNCED** (22/06) — a quitté AFEDIM ou domaine différent | Strasbourg |
| **Sonia GRIMMER** ⭐⭐ | **Assistante** — agence CM-CIC/AFEDIM Strasbourg | `sonia.grimmer@afedim.fr` | ✅ **VALIDE** (non-bounced 22/06) | Strasbourg |
| ~~**Franck DESCHODT**~~ | Représentant légal AFEDIM Strasbourg | ~~`franck.deschodt@afedim.fr`~~ | ❌ **BOUNCED** (22/06) — email parent company ? | Strasbourg |
| **Marie PAILHÉ** | Responsable d'unité Gestion locative | `marie.pailhe@afedim.fr` | 🔶 format probable | (Nantes probable) |
| **Clarisse GLOTIN** ⭐⭐ | Gestionnaire locative | `clarisse.glotin@afedim.fr` | ✅ **VALIDE** (non-bounced 22/06) | — |
...
**Agents habilités CCI Alsace Eurométropole (attestations valides jusqu'en 09/2026) — format `prenom.nom@afedim.fr` (98,8%) :**
...
| Caroline SCHWOB | AFEDIM · attestation CCI | `caroline.schwob@afedim.fr` | 🔶 |

**Dirigeant niveau groupe (domaine différent) :**
| **Franck DESCHODT** | Directeur Crédit Mutuel Immobilier (groupe) | `franck.deschodt@cmcic-immobilier.fr` | 🔶 format 97,8% (cmcic-immobilier.fr) — ≠ @afedim.fr |
